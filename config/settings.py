...
# Database - SQLite for example; use PostgreSQL/MySQL on KloudBean for production
DATABASES = {
    'default': {
...
# On KloudBean you can set DATABASE_URL and use dj-database-url for PostgreSQL/MySQL
